...
@ControllerAdvice //
public class TratamentoExcecao extends ResponseEntityExceptionHandler { //toda resposta do controlador é response, e usando essa classe, temos todas as exceções
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<Erro> erros = gerarListaDeErros(ex.getBindingResult());  //lista de erros com mensagem de usuario e msg de desenvolvedor, tendo as exceções e o resultado das exceções
    ...
    public ResponseEntity<Object> handleArithmeticException(ArithmeticException ex, WebRequest request) {
        String msgUsuario = "não pode dividir por zero";
